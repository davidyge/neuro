...
const Banner = () => {
    ...
    const images = ["/images/Banner/asesora.webp", "/images/Banner/punto_venta.webp"];
                        ...
                        <div className='col-span-7'>
                            ...
                            <div className='flex align-middle justify-center md:justify-start'>
                                ...
                                <button className='text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton mr-6'>
                                    <a href="https://wa.link/pzw01y" target="_blank">Mas información</a></button>
                            ...
                            <button onClick={() => setOpen(true)} className='btn_b bg-transparent flex justify-center items-center text-black'>
                                <div className='icon_banner_ant'>
                                    <div className='icon_banner'>
                                        <Image id="expanding-icono" src={'/images/Banner/icono.svg'} alt="button-image" width={65} height={65} loading="eager" />
                                    </div>
                                </div>
                            </button>
                        </div>
